...
const ChatComponent = () => {
  ...
  align-items: center;
  gap: 8px;
  box-shadow: 0 8px 20px rgba(3, 20, 14, 0.2);
  border: 2px solid silver; /* ✅ always visible silver border */
  cursor: pointer;
  z-index: 9999;
  font-weight: 500;
  ...
  box-shadow: 0 0 12px rgba(192,192,192,0.7), 0 12px 30px rgba(3,20,14,0.25);
  border-color: #e0e0e0; /* lighter silver on hover */
}
        .chat-fab-icon { font-size: 18px; }
        .chat-fab-text { font-size: 15px; }
